...
#          
            ...
            if ( ifail < 0 ) :
                print("Error in call to PyUL220.  ifail = ",ifail, i, j, dlm)
                break
    #
...
#             print("              invariant radius   = %22.15E Re" %frd[0])
#             print("              invairant latitude = %22.15E deg" %fla[0])
#             print(" -------------------------")
